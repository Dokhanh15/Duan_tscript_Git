...
const App = () => {
  ...
  const handleDel = (id: number | undefined) => {
    ...
    (async () => {
      const confirm = window.confirm('Bạn chắc chắn muốn xóa sản phẩm này chứ?')
      if (confirm) {
    ...
    <div>
      ...
      <Routes>
        ...
        <Route path="/admin" element={<LayoutAdmin />} >
          ...
          <Route path="products" element={<ProductsAdmin products={products} onDel={handleDel} />} />
          <Route path="products/add" element={<AddProduct onAdd={handleAdd} />} />
          <Route path="products/edit/:id" element={<ProductsEdit onEdit={handleEditProduct} />} />
        </Route>
